...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    ...
    if (eventTitle.length) {
      ...
      select2Focus(eventTitle);
      eventTitle.wrap('<div class="position-relative"></div>').select2({
        placeholder: 'Select name',
        dropdownParent: eventTitle.parent(),
        closeOnSelect: true,
    ...
    if (eventDescription.length) {
      ...
      select2Focus(eventDescription);
      eventDescription.wrap('<div class="position-relative"></div>').select2({
        placeholder: 'Select value',
        dropdownParent: eventDescription.parent(),
        closeOnSelect: true,
        templateResult: renderGuestAvatar,
        templateSelection: renderGuestAvatar,
        escapeMarkup: function (es) {
...
if (eventStartDate) {
  var start = eventStartDate.flatpickr({
    ...
    dateFormat: 'Y-m-dTH:i:S', // Update the date format
...
if (eventEndDate) {
  var end = eventEndDate.flatpickr({
    ...
    function eventClick(info) {
      ...
      eventToUpdate.title !== undefined
        ? eventTitle.val(eventToUpdate.title).trigger('change')
        : null;
      ...
      eventToUpdate.extendedProps.description !== undefined
        ? eventDescription.val(eventToUpdate.extendedProps.description).trigger('change')
        : null;
    ...
    function resetValues() {
      ...
      eventDescription.val('').trigger('change');
